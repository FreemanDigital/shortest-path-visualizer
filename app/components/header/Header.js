...
const Header = () => {
  return (
    <div className="flex flex-row justify-center items-center text-center h-full w-full bg-gray-800 text-white text-xl z-10" style={{ gridArea: "header" }}>
        <div className="flex justify-center items-end w-6 h-6 mr-2">
        ...
        <div className="flex flex-col justify-center items-start ml-8 text-sm">
